...
public class UserLogin1 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("joe@ servlet path is : " + request.getServletPath());
		System.out.println("joe@ path is : " + request.getContextPath());
        ...
        PrintWriter out = response.getWriter();
			...
			if (result.equals("error")){			
				out.print("<script>alert('�û������������');window.location.href='http://localhost:8080/ShouQiSystem/login.jsp';</script>");
			}else{
