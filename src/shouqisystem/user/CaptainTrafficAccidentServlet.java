...
/**
 * Servlet implementation class CaptainTrafficAccidentServlet
 */
public class CaptainTrafficAccidentServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CaptainTrafficAccidentServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		 ...
		 String s1="CaptainBeginQueryTrafficAccident.jsp";
