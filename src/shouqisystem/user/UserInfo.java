...
//	    		Class.forName(driverName);
	    ...
	    public void addCaptainTrafficViolationRemind(String name,String carNum,String violationTime,String violationLocation,String violationPlot)throws Exception{
	    	pstmt=null;
	    	String sql="insert into captainTrafficViolationRemind(name,carNum,violationTime,violationLocation,violationPlot)values(?,?,?,?,?)";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void addManTrafficViolationRemind(String name,String carNum,String violationTime,String violationLocation,String violationPlot)throws Exception{
	    	pstmt=null;
	    	String sql="insert into manTrafficViolationRemind(name,carNum,violationTime,violationLocation,violationPlot)values(?,?,?,?,?)";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void editCaptainTrafficViolationRemind(int ID,String name,String carNum,String violationTime,String violationLocation,String violationPlot)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="update captainTrafficViolationRemind set name=?,carNum=?,violationTime=?,violationLocation=?,violationPlot=? where ID=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void editManTrafficViolationRemind(int ID,String name,String carNum,String violationTime,String violationLocation,String violationPlot)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="update manTrafficViolationRemind set name=?,carNum=?,violationTime=?,violationLocation=?,violationPlot=? where ID=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void deleteCaptainTrafficViolationRemind(int[] IDs)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="delete from captainTrafficViolationRemind where ID=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void deleteManTrafficViolationRemind(int[] IDs)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="delete from manTrafficViolationRemind where ID=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void deleteCaptainTrafficViolationRemind2(String name,String carNum)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="delete from captainTrafficViolationRemind where name=?"+"and carNum=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);	    		
	    ...
	    public void deleteManTrafficViolationRemind2(String name,String carNum)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="delete from manTrafficViolationRemind where name=?"+"and carNum=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);	    		
	    ...
	    public void addCaptainTrafficAccidentRemind(String name,String carNum,String accidentTime,String accidentLocation,String accidentPlot,String accidentReason,String accidentLoss,String strongInsuranceReimburseSum,String threeInsuranceReimburseSum,String companyBurdenSum,String dirverBurdenSum)throws Exception{
	    	pstmt=null;
	    	String sql="insert into captaintrafficaccidentremind(name,carNum,accidentTime,accidentLocation,accidentPlot,accidentReason,accidentLoss,strongInsuranceReimburseSum,threeInsuranceReimburseSum,companyBurdenSum,dirverBurdenSum)values(?,?,?,?,?,?,?,?,?,?,?)";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void addManTrafficAccidentRemind(String name,String carNum,String accidentTime,String accidentLocation,String accidentPlot,String accidentReason,String accidentLoss,String strongInsuranceReimburseSum,String threeInsuranceReimburseSum,String companyBurdenSum,String dirverBurdenSum)throws Exception{
	    	pstmt=null;
	    	String sql="insert into manTrafficAccidentRemind(name,carNum,accidentTime,accidentLocation,accidentPlot,accidentReason,accidentLoss,strongInsuranceReimburseSum,threeInsuranceReimburseSum,companyBurdenSum,dirverBurdenSum)values(?,?,?,?,?,?,?,?,?,?,?)";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void editCaptainTrafficAccidentRemind(int ID,String name,String carNum,String accidentTime,String accidentLocation,String accidentPlot,String accidentReason,String accidentLoss,String strongInsuranceReimburseSum,String threeInsuranceReimburseSum,String companyBurdenSum,String dirverBurdenSum)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="update captaintrafficaccidentremind set name=?,carNum=?,accidentTime=?,accidentLocation=?,accidentPlot=?,accidentReason=?,accidentLoss=?,strongInsuranceReimburseSum=?,threeInsuranceReimburseSum=?,companyBurdenSum=?,dirverBurdenSum=? where ID=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void editManTrafficAccidentRemind(int ID,String name,String carNum,String accidentTime,String accidentLocation,String accidentPlot,String accidentReason,String accidentLoss,String strongInsuranceReimburseSum,String threeInsuranceReimburseSum,String companyBurdenSum,String dirverBurdenSum)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="update manTrafficAccidentRemind set name=?,carNum=?,accidentTime=?,accidentLocation=?,accidentPlot=?,accidentReason=?,accidentLoss=?,strongInsuranceReimburseSum=?,threeInsuranceReimburseSum=?,companyBurdenSum=?,dirverBurdenSum=? where ID=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void deleteCaptainTrafficAccidentRemind(int[] IDs)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="delete from captaintrafficaccidentremind where ID=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void deleteManTrafficAccidentRemind(int[] IDs)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="delete from mantrafficaccidentremind where ID=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void deleteCaptainTrafficAccidentRemind2(String name,String carNum)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="delete from captaintrafficaccidentremind where name=?"+"and carNum=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);	    		
	    ...
	    public void deleteManTrafficAccidentRemind2(String name,String carNum)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="delete from mantrafficaccidentremind where name=?"+"and carNum=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);	    		
	    ...
	    public void addCaptainDynamicMonitorRemind(String name,String carNum,String speedTime,String speedFourLevelTimes,String outGoingTime,String destination,String fatigueDrivingTime,String degree,String times)throws Exception{
	    	pstmt=null;
	    	String sql="insert into captaindynamicmonitorremind(name,carNum,speedTime,speedFourLevelTimes,outGoingTime,destination,fatigueDrivingTime,degree,times)values(?,?,?,?,?,?,?,?,?)";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void addManDynamicMonitorRemind(String name,String carNum,String speedTime,String speedFourLevelTimes,String outGoingTime,String destination,String fatigueDrivingTime,String degree,String times)throws Exception{
	    	pstmt=null;
	    	String sql="insert into manDynamicMonitorRemind(name,carNum,speedTime,speedFourLevelTimes,outGoingTime,destination,fatigueDrivingTime,degree,times)values(?,?,?,?,?,?,?,?,?)";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void editCaptainDynamicMonitorRemind(int ID,String name,String carNum,String speedTime,String speedFourLevelTimes,String outGoingTime,String destination,String fatigueDrivingTime,String degree,String times)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="update captaindynamicmonitorremind set name=?,carNum=?,speedTime=?,speedFourLevelTimes=?,outGoingTime=?,destination=?,fatigueDrivingTime=?,degree=?,times=? where ID=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void editManDynamicMonitorRemind(int ID,String name,String carNum,String speedTime,String speedFourLevelTimes,String outGoingTime,String destination,String fatigueDrivingTime,String degree,String times)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="update manDynamicMonitorRemind set name=?,carNum=?,speedTime=?,speedFourLevelTimes=?,outGoingTime=?,destination=?,fatigueDrivingTime=?,degree=?,times=? where ID=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void deleteCaptainDynamicMonitorRemind(int[] IDs)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="delete from captaindynamicmonitorremind where ID=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void deleteManDynamicMonitorRemind(int[] IDs)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="delete from mandynamicmonitorremind where ID=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void deleteCaptainDynamicMonitorRemind2(String name,String carNum)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="delete from captaindynamicmonitorremind where name=?"+"and carNum=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);	    		
	    ...
	    public void deleteManDynamicMonitorRemind2(String name,String carNum)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="delete from mandynamicmonitorremind where name=?"+"and carNum=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);	    		
	    ...
	    public void addCaptainICcardDataRemind(String name,String carNum,String ICdate,String monthIncomeTopTen,String monthIncomeBottomTen,String monthWorkTimeExceed,String monthRunKmExceed)throws Exception{
	    	pstmt=null;
	    	String sql="insert into captainiccarddataremind(name,carNum,ICdate,monthIncomeTopTen,monthIncomeBottomTen,monthWorkTimeExceed,monthRunKmExceed)values(?,?,?,?,?,?,?)";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void addManICcardDataRemind(String name,String carNum,String ICdate,String monthIncomeTopTen,String monthIncomeBottomTen,String monthWorkTimeExceed,String monthRunKmExceed)throws Exception{
	    	pstmt=null;
	    	String sql="insert into manICCardDataRemind(name,carNum,ICdate,monthIncomeTopTen,monthIncomeBottomTen,monthWorkTimeExceed,monthRunKmExceed)values(?,?,?,?,?,?,?)";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void editCaptainICcardDataRemind(int ID,String name,String carNum,String ICdate,String monthIncomeTopTen,String monthIncomeBottomTen,String monthWorkTimeExceed,String monthRunKmExceed)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="update captainiccarddataremind set name=?,carNum=?,ICdate=?,monthIncomeTopTen=?,monthIncomeBottomTen=?,monthWorkTimeExceed=?,monthRunKmExceed=? where ID=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void editManICcardDataRemind(int ID,String name,String carNum,String ICdate,String monthIncomeTopTen,String monthIncomeBottomTen,String monthWorkTimeExceed,String monthRunKmExceed)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="update maniccarddataremind set name=?,carNum=?,ICdate=?,monthIncomeTopTen=?,monthIncomeBottomTen=?,monthWorkTimeExceed=?,monthRunKmExceed=? where ID=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void deleteCaptainICcardDataRemind(int[] IDs)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="delete from captainiccarddataremind where ID=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void deleteManICcardDataRemind(int[] IDs)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="delete from maniccarddataremind where ID=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void deleteCaptainICcardDataRemind2(String name,String carNum)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="delete from captainiccarddataremind where name=?"+"and carNum=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);	    		
	    ...
	    public void deleteManICcardDataRemind2(String name,String carNum)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="delete from maniccarddataremind where name=?"+"and carNum=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);	    		
	    ...
	    public void addCaptainTrainRecordRemind(String name,String carNum,String unjoinTrainTime)throws Exception{
	    	pstmt=null;
	    	String sql="insert into captaintrainrecordremind(name,carNum,unjoinTrainTime)values(?,?,?)";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void addManTrainRecordRemind(String name,String carNum,String unjoinTrainTime)throws Exception{
	    	pstmt=null;
	    	String sql="insert into manTrainRecordRemind(name,carNum,unjoinTrainTime)values(?,?,?)";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void editCaptainTrainRecordRemind(int ID,String name,String carNum,String unjoinTrainTime)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="update captaintrainrecordremind set name=?,carNum=?,unjoinTrainTime=? where ID=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void editManTrainRecordRemind(int ID,String name,String carNum,String unjoinTrainTime)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="update mantrainrecordremind set name=?,carNum=?,unjoinTrainTime=? where ID=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void deleteCaptainTrainRecordRemind(int[] IDs)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="delete from captaintrainrecordremind where ID=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void deleteManTrainRecordRemind(int[] IDs)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="delete from mantrainrecordremind where ID=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void deleteCaptainTrainRecordRemind2(String name,String carNum)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="delete from captaintrainrecordremind where name=?"+"and carNum=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);	    		
	    ...
	    public void deleteManTrainRecordRemind2(String name,String carNum)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="delete from mantrainrecordremind where name=?"+"and carNum=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);	    		
	    ...
	    public void addCaptainServiceRemind(String name,String carNum,String complaintTime,String complaintPlot,String serviceDisciplineTime,String serviceDisciplinePlot)throws Exception{
	    	pstmt=null;
	    	String sql="insert into captainserviceremind(name,carNum,complaintTime,complaintPlot,serviceDisciplineTime,serviceDisciplinePlot)values(?,?,?,?,?,?)";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void addManServiceRemind(String name,String carNum,String complaintTime,String complaintPlot,String serviceDisciplineTime,String serviceDisciplinePlot)throws Exception{
	    	pstmt=null;
	    	String sql="insert into manserviceremind(name,carNum,complaintTime,complaintPlot,serviceDisciplineTime,serviceDisciplinePlot)values(?,?,?,?,?,?)";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void editCaptainServiceRemind(int ID,String name,String carNum,String complaintTime,String complaintPlot,String serviceDisciplineTime,String serviceDisciplinePlot)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="update captainserviceremind set name=?,carNum=?,complaintTime=?,complaintPlot=?,serviceDisciplineTime=?,serviceDisciplinePlot=? where ID=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void editManServiceRemind(int ID,String name,String carNum,String complaintTime,String complaintPlot,String serviceDisciplineTime,String serviceDisciplinePlot)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="update manserviceremind set name=?,carNum=?,complaintTime=?,complaintPlot=?,serviceDisciplineTime=?,serviceDisciplinePlot=? where ID=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void deleteCaptainServiceRemind(int[] IDs)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="delete from captainserviceremind where ID=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void deleteManServiceRemind(int[] IDs)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="delete from manserviceremind where ID=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void deleteCaptainServiceRemind2(String name,String carNum)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="delete from captainserviceremind where name=?"+"and carNum=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);	    		
	    ...
	    public void deleteManServiceRemind2(String name,String carNum)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="delete from manserviceremind where name=?"+"and carNum=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);	    		
	    ...
	    public void addCaptainTechnologyRemind(String name,String carNum,String noRuleMaintainTime,String noRuleMaintainKm)throws Exception{
	    	pstmt=null;
	    	String sql="insert into captaintechnologyremind(name,carNum,noRuleMaintainTime,noRuleMaintainKm)values(?,?,?,?)";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void addManTechnologyRemind(String name,String carNum,String noRuleMaintainTime,String noRuleMaintainKm)throws Exception{
	    	pstmt=null;
	    	String sql="insert into mantechnologyremind(name,carNum,noRuleMaintainTime,noRuleMaintainKm)values(?,?,?,?)";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void editCaptainTechnologyRemind(int ID,String name,String carNum,String noRuleMaintainTime,String noRuleMaintainKm)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="update captaintechnologyremind set name=?,carNum=?,noRuleMaintainTime=?,noRuleMaintainKm=? where ID=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void editManTechnologyRemind(int ID,String name,String carNum,String noRuleMaintainTime,String noRuleMaintainKm)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="update mantechnologyremind set name=?,carNum=?,noRuleMaintainTime=?,noRuleMaintainKm=? where ID=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void deleteCaptainTechnologyRemind(int[] IDs)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="delete from captaintechnologyremind where ID=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void deleteManTechnologyRemind(int[] IDs)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="delete from mantechnologyremind where ID=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void deleteCaptainTechnologyRemind2(String name,String carNum)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="delete from captaintechnologyremind where name=?"+"and carNum=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);	    		
	    ...
	    public void deleteManTechnologyRemind2(String name,String carNum)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="delete from mantechnologyremind where name=?"+"and carNum=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);	    		
	    ...
	    public void addCaptainFinanceRemind(String name,String carNum,String postponePayDate,String postponeDays,String overdueFine)throws Exception{
	    	pstmt=null;
	    	String sql="insert into captainfinanceremind(name,carNum,postponePayDate,postponeDays,overdueFine)values(?,?,?,?,?)";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void addManFinanceRemind(String name,String carNum,String postponePayDate,String postponeDays,String overdueFine)throws Exception{
	    	pstmt=null;
	    	String sql="insert into manfinanceremind(name,carNum,postponePayDate,postponeDays,overdueFine)values(?,?,?,?,?)";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void editManFinanceRemind(int ID,String name,String carNum,String postponePayDate,String postponeDays,String overdueFine)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="update manfinanceremind set name=?,carNum=?,postponePayDate=?,postponeDays=?,overdueFine=? where ID=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void editCaptainFinanceRemind(int ID,String name,String carNum,String postponePayDate,String postponeDays,String overdueFine)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="update captainfinanceremind set name=?,carNum=?,postponePayDate=?,postponeDays=?,overdueFine=? where ID=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void deleteCaptainFinanceRemind(int[] IDs)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="delete from captainfinanceremind where ID=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void deleteManFinanceRemind(int[] IDs)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="delete from manfinanceremind where ID=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void deleteCaptainFinanceRemind2(String name,String carNum)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="delete from captainfinanceremind where name=?"+"and carNum=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);	    		
	    ...
	    public void deleteManFinanceRemind2(String name,String carNum)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="delete from manfinanceremind where name=?"+"and carNum=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);	    		
	    ...
	    public void addCaptainLabourRemind(String name,String carNum,String inHospitalTime,String diseaseCause,String yearMedicalTwiceReimburse)throws Exception{
	    	pstmt=null;
	    	String sql="insert into captainlabourremind(name,carNum,inHospitalTime,diseaseCause,yearMedicalTwiceReimburse)values(?,?,?,?,?)";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void addManLabourRemind(String name,String carNum,String inHospitalTime,String diseaseCause,String yearMedicalTwiceReimburse)throws Exception{
	    	pstmt=null;
	    	String sql="insert into manlabourremind(name,carNum,inHospitalTime,diseaseCause,yearMedicalTwiceReimburse)values(?,?,?,?,?)";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void editCaptainLabourRemind(int ID,String name,String carNum,String inHospitalTime,String diseaseCause,String yearMedicalTwiceReimburse)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="update captainlabourremind set name=?,carNum=?,inHospitalTime=?,diseaseCause=?,yearMedicalTwiceReimburse=? where ID=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void editManLabourRemind(int ID,String name,String carNum,String inHospitalTime,String diseaseCause,String yearMedicalTwiceReimburse)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="update manlabourremind set name=?,carNum=?,inHospitalTime=?,diseaseCause=?,yearMedicalTwiceReimburse=? where ID=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void deleteCaptainLabourRemind(int[] IDs)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="delete from captainlabourremind where ID=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void deleteManLabourRemind(int[] IDs)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="delete from manlabourremind where ID=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);
	    ...
	    public void deleteCaptainLabourRemind2(String name,String carNum)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="delete from captainlabourremind where name=?"+"and carNum=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);	    		
	    ...
	    public void deleteManLabourRemind2(String name,String carNum)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	String sql="delete from manlabourRemind where name=?"+"and carNum=?";
	    	try{
	    		Class.forName("com.mysql.jdbc.Driver"); 
	    		conn=DriverManager.getConnection(urls);
	    		pstmt=conn.prepareStatement(sql);	    		
	    ...
	    public void editCaptainPersonInfo(int ID,String userName,String userPassword)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    ...
	    public int queryUserID(String userName,String userPassword)throws Exception{
	    	ResultSet rs=null;
	    	pstmt=null;
	    	int id=0;
	    	String sql="select * from user where userName=?"+"and userPassword=?";
