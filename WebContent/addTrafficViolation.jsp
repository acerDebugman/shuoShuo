...
<form action="updateAddTrafficViolation.jsp" method="get" name="addTrafficViolationFrom">
<table boder="1" align="center">
   ...
   <tr>
      ...
      <td><input type="text" name="violationTime" size="30" onchange="strDateTime()"/>格式为：YYYY-MM-DD HH:MM:SS</td>
   </tr>
   <tr><span style="color:white">
      <td align="right"><span style="color:white">违法地点：</span></td>
      <td><input type="text" name="violationLocation" size="30" /></td>
   </tr>
   <tr>
      <td align="right"><span style="color:white">违法情节：</span></td>
      <td><input type="text" name="violationPlot" size="30" /></td>
   </tr>
   <tr align="right">
      <td colspan="2">
