...
<%
 ...
 userinfo.editCaptainServiceRemind(ID, name, carNum, complaintTime, complaintPlot, serviceDisciplineTime, serviceDisciplinePlot);
 userinfo.editManServiceRemind(ID, name, carNum, complaintTime, complaintPlot, serviceDisciplineTime, serviceDisciplinePlot);
%>
