...
<%
   ...
   userinfo.deleteTrafficViolation(IDs);
   userinfo.deleteTrafficViolationRemind(IDs);
   userinfo.deleteCaptainTrafficViolationRemind(IDs);
   userinfo.deleteManTrafficViolationRemind(IDs);
%>
