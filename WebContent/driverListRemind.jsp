...
<br>
   <%
      ...
      String employeeCardNum=(String)session.getAttribute("employeeCardNum");
  ...
  <tr>
   ...
   <tr align="right">
           <td colspan="2">
             <input type="submit" name="trafficViolation" value="交通违法" onclick="form.action='TrafficViolationServlet';form.submit();">
           </td>
           <td colspan="2">
             <input type="submit" name="trafficAccident" value="交通事故" onclick="form.action='TrafficAccidentServlet';form.submit();">
           </td>
           <td colspan="2">
             <input type="submit" name="dynamicMonitor" value="动态监控" onclick="form.action='DynamicMonitorServlet';form.submit();">
           </td>
   </tr><br>
   <tr align="right">
           <td colspan="2">
             <input type="submit" name="ICcardData" value="IC卡数据" onclick="form.action='ICcardDataServlet';form.submit();">
           </td>
           <td colspan="2">
             <input type="submit" name="trainRecord" value="培训记录" onclick="form.action='TrainRecordServlet';form.submit();">
           </td>
           <td colspan="2">
             <input type="submit" name="service" value="服务" onclick="form.action='ServiceServlet';form.submit();">
           </td>
   </tr>
   <tr align="right">
           <td colspan="2">
             <input type="submit" name="technology" value="技术" onclick="form.action='TechnologyServlet';form.submit();">
           </td>
           <td colspan="2">
             <input type="submit" name="finance" value="财务" onclick="form.action='FinanceServlet';form.submit();">
           </td>
           <td colspan="2">
             <input type="submit" name="labour" value="劳动" onclick="form.action='LabourServlet';form.submit();">
           </td>
   </tr>
   </table><br><br>
   </form>
