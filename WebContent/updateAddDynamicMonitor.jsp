...
<body background="images/bottom.png">
   <%
      ...
      userinfo.addCaptainDynamicMonitorRemind(name, carNum, speedTime, speedFourLevelTimes, outGoingTime, destination, fatigueDrivingTime, degree, times);
      userinfo.addManDynamicMonitorRemind(name, carNum, speedTime, speedFourLevelTimes, outGoingTime, destination, fatigueDrivingTime, degree, times);
   %>
