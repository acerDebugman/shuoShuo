...
<form action="updateAddTrafficAccident.jsp" method="get" name="addTrafficAccidentFrom">
<table boder="1" align="center">
   ...
   <tr>
      ...
      <td><input type="text" name="accidentTime" size="30" onchange="strDateTime()"/>格式为：YYYY-MM-DD HH:MM:SS</td>
   </tr>
   <tr><span style="color:white">
      <td align="right"><span style="color:white">事故地点：</span></td>
      <td><input type="text" name="accidentLocation" size="30" /></td>
   </tr>
   <tr>
      <td align="right"><span style="color:white">事故情节：</span></td>
      <td><input type="text" name="accidentPlot" size="30" /></td>
   </tr>
   <tr>
      <td align="right"><span style="color:white">事故原因：</span></td>
      <td><input type="text" name="accidentReason" size="30" /></td>
   </tr>
   <tr>
      <td align="right"><span style="color:white">事故损失：</span></td>
      <td><input type="text" name="accidentLoss" size="30" /></td>
   </tr>
   <tr>
      <td align="right"><span style="color:white">交强险报销金额：</span></td>
      <td><input type="text" name="strongInsuranceReimburseSum" size="30" /></td>
   </tr>
   <tr>
      <td align="right"><span style="color:white">三者险报销金额：</span></td>
      <td><input type="text" name="threeInsuranceReimburseSum" size="30" /></td>
   </tr>
   <tr>
      <td align="right"><span style="color:white">企业负担金额：</span></td>
      <td><input type="text" name="companyBurdenSum" size="30" /></td>
   </tr>
   <tr>
      <td align="right"><span style="color:white">司机负担金额：</span></td>
      <td><input type="text" name="dirverBurdenSum" size="30" /></td>
   </tr>
   <tr align="right">
      <td colspan="2">
