...
<form action="updateAddDynamicMonitor.jsp" method="get" name="addDynamicMonitorFrom">
<table boder="1" align="center">
   ...
   <tr>
      ...
      <td><input type="text" name="speedTime" size="30" onchange="strDateTime()"/>格式为：YYYY-MM-DD HH:MM:SS</td>
   </tr>
   <tr><span style="color:white">
      <td align="right"><span style="color:white">超速4级次数：</span></td>
      <td><input type="text" name="speedFourLevelTimes" size="30" />次</td>
   </tr>
   <tr>
      <td align="right"><span style="color:white">出外埠日期：</span></td>
      <td><input type="text" name="outGoingTime" size="30" onchange="strDateTime()"/>格式为：YYYY-MM-DD HH:MM:SS</td>
   </tr>
   <tr>
   ...
   <tr>
      ...
      <td><input type="text" name="fatigueDrivingTime" size="30" onchange="strDateTime()"/>格式为：YYYY-MM-DD HH:MM:SS</td>
   </tr>
   <tr>
   ...
   <tr>
      ...
      <td><input type="text" name="times" size="30" />次</td>
   </tr>
   <tr align="right">
      <td colspan="2">
