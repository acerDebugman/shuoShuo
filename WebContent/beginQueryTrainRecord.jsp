...
<center>
  ...
  <tr>
     ...
     <td><b><span style="color:white">未参加车队培训月份</span></b></td>
  </tr>
  <%
  ...
  ResultSet CountTopicrs=userinfo.queryTrainRecordSum(name, carNum);
  ResultSet rs=userinfo.queryTrainRecord(name, carNum);
  ...
  <tr>
      ...
      <td><span style="color:white"><%=rs.getString("unjoinTrainTime") %></span></td>
  </tr>
  <%    
          }
      }
  ...
  pages.close_all();
   ...
   <tr align="right">
           <td colspan="2">
             <input type="submit" name="revise" value="修改" onclick="form.action='reviseTrainRecord.jsp';form.submit();">
             <input type="submit" name="delete" value="删除" onclick="form.action='deleteTrainRecord.jsp';form.submit();">
           </td>
   </tr>
