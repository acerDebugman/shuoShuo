...
<br><br><br><br><br>
   <%
      ...
      ResultSet rs=userinfo.queryTrainRecordID(Integer.parseInt(kys[0]));
      while(rs.next()){
   %>
<center>
       <form action="updateEditTrainRecord.jsp" method="GET">
  <table boder="1">
  <tr>
 ...
 <tr>
 <td align="right"><span style="color:white">未参加车队培训月份：</span></td>
 <td><input type="text" name="unjoinTrainTime" size="20" value="<%=rs.getString("unjoinTrainTime") %>"/></td>
 </tr>
 <tr>
