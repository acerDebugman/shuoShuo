<%@ page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8"%>
<%@ page import="java.io.*,java.util.*,java.sql.*,shouQiSystem.user.*,java.util.Date" %>
...
<br><br><br><br><br>
   <%
      ...
      ResultSet rs=userinfo.queryTechnologyID(Integer.parseInt(kys[0]));
      while(rs.next()){
   %>
<center>
       <form action="updateEditTechnology.jsp" method="GET">
  <table boder="1">
  <tr>
 ...
 <tr>
 <td align="right"><span style="color:white">未按规定保养日期：</span></td>
 <td><input type="text" name="noRuleMaintainTime" size="20" value="<%=rs.getString("noRuleMaintainTime").substring(0, 10) %>"/></td>
 </tr>
 <tr>
 <td align="right"><span style="color:white">未按规定保养公里数：</span></td>
 <td><input type="text" name="noRuleMaintainKm" size="20" value="<%=rs.getString("noRuleMaintainKm") %>"/></td>
 </tr>
 <tr>
