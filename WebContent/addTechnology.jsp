...
<form action="updateAddTechnology.jsp" method="get" name="addTechnologyFrom">
<table boder="1" align="center">
   ...
   <tr>
      ...
      <td><input type="text" name="noRuleMaintainTime" size="30" onchange="strDateTime()"/>格式为：YYYY-MM-DD</td>
   </tr>
   <tr><span style="color:white">
      <td align="right"><span style="color:white">未按规定保养公里数：</span></td>
      <td><input type="text" name="noRuleMaintainKm" size="30" />公里</td>
   </tr>
   <tr align="right">
      <td colspan="2">
