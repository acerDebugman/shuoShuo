...
<form action="updateAddService.jsp" method="get" name="addServiecFrom">
<table boder="1" align="center">
   ...
   <tr>
      ...
      <td><input type="text" name="complaintTime" size="30" onchange="strDateTime()"/>格式为：YYYY-MM-DD HH:MM:SS</td>
   </tr>
   <tr><span style="color:white">
      <td align="right"><span style="color:white">投诉情节：</span></td>
      <td><input type="text" name="complaintPlot" size="30" /></td>
   </tr>
   <tr>
      <td align="right"><span style="color:white">服务违纪时间：</span></td>
      <td><input type="text" name="serviceDisciplineTime" size="30" onchange="strDateTime()"/>格式为：YYYY-MM-DD HH:MM:SS</td>
   </tr>
   <tr>
      <td align="right"><span style="color:white">服务违纪情节：</span></td>
      <td><input type="text" name="serviceDisciplinePlot" size="30" /></td>
   </tr>
   <tr align="right">
      <td colspan="2">
