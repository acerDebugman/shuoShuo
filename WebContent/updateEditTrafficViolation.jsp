...
<%
 ...
 userinfo.editCaptainTrafficViolationRemind(ID, name, carNum, violationTime, violationLocation, violationPlot);
 userinfo.editManTrafficViolationRemind(ID, name, carNum, violationTime, violationLocation, violationPlot);
%>
