...
<%
   ...
   userinfo.deleteTrainRecord(IDs);
   userinfo.deleteTrainRecordRemind(IDs);
   userinfo.deleteCaptainTrainRecordRemind(IDs);
   userinfo.deleteManTrainRecordRemind(IDs);
%>
