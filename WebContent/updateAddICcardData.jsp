...
<body background="images/bottom.png">
   <%
      ...
      userinfo.addCaptainICcardDataRemind(name, carNum, ICdate, monthIncomeTopTen, monthIncomeBottomTen, monthWorkTimeExceed, monthRunKmExceed);
      userinfo.addManICcardDataRemind(name, carNum, ICdate, monthIncomeTopTen, monthIncomeBottomTen, monthWorkTimeExceed, monthRunKmExceed);
   %>
