...
<center>
  ...
  <tr>
     ...
     <td><b><span style="color:white">违法时间</span></b></td>
     <td><b><span style="color:white">违法地点</span></b></td>
     <td><b><span style="color:white">违法情节</span></b></td>
  </tr>
  <%

  String name=(String)session.getAttribute("name");
  String carNum=(String)session.getAttribute("carNum");
  ResultSet CountTopicrs=userinfo.queryTrafficViolationSum(name, carNum);
  ResultSet rs=userinfo.queryTrafficViolation(name, carNum);
  ...
  <tr>
      ...
      <td><span style="color:white"><%=rs.getString("violationTime") %></span></td>
      <td><span style="color:white"><%=rs.getString("violationLocation") %></span></td>
      <td><span style="color:white"><%=rs.getString("violationPlot") %></span></td>
  </tr>
  <%    
          }
      }
  ...
  pages.close_all();
   ...
   <tr align="right">
           <td colspan="2">
             <input type="submit" name="revise" value="修改" onclick="form.action='reviseTrafficViolation.jsp';form.submit();">
             <input type="submit" name="delete" value="删除" onclick="form.action='deleteTrafficViolation.jsp';form.submit();">
           </td>
   </tr>
