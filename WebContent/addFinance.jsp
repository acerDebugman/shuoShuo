...
<form action="updateAddFinance.jsp" method="get" name="addFinanceFrom">
<table boder="1" align="center">
   ...
   <tr>
      ...
      <td><input type="text" name="postponePayDate" size="30" onchange="strDateTime()"/>格式为：YYYY-MM-DD</td>
   </tr>
   <tr><span style="color:white">
      <td align="right"><span style="color:white">拖延天数：</span></td>
      <td><input type="text" name="postponeDays" size="30" />天</td>
   </tr>
   <tr>
      <td align="right"><span style="color:white">滞纳金：</span></td>
      <td><input type="text" name="overdueFine" size="30" />元</td>
   </tr>
   <tr align="right">
      <td colspan="2">
