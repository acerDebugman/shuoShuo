...
<meta http-equiv="refresh" content="3; URL=managerBottom.jsp; charset=utf-8">  
<title>底部页面</title>
</head>
<body background="images/bottom.png">
   <center>
    <form action="" method="GET" name="form" target="managerMain">
  ...
  <tr>
      <%
        ...
        String trafficViolationSql="select * from mantrafficViolationRemind order by ID desc limit 0,1";
      ...
      %>
       ...
       <tr>
      <%            
        String trafficAccidentSql="select * from mantrafficAccidentRemind order by ID desc limit 0,1";
      ...
      %>
       <tr>
      <%            
        String dynamicMonitorSql="select * from mandynamicMonitorRemind order by ID desc limit 0,1";
      ...
      %>
       ...
       <tr>
      <%            
        String ICcardDataSql="select * from manICcardDataRemind order by ID desc limit 0,1";
      ...
      <tr>
      <%            
        String trainRecordSql="select * from mantrainRecordRemind order by ID desc limit 0,1";
      ...
      <tr>
      <%            
        String serviceSql="select * from manserviceRemind order by ID desc limit 0,1";
      ...
      %>
       ...
       <tr>
      <%            
        String technologySql="select * from mantechnologyRemind order by ID desc limit 0,1";
      ...
      %>
       ...
       <tr>
      <%            
        String financeSql="select * from manfinanceRemind order by ID desc limit 0,1";
      ...
      <tr>
      <%            
        String labourSql="select * from manlabourRemind order by ID desc limit 0,1";
      ...
      <tr align="right">
           <td colspan="2">
             <input type="submit" name="look" value="查看" onclick="form.action='ManagerRemindServlet';form.submit();">
           </td>
      </tr>
   </center>
