...
<%
 ...
 userinfo.editCaptainLabourRemind(ID, name, carNum, inHospitalTime, diseaseCause, yearMedicalTwiceReimburse);
 userinfo.editManLabourRemind(ID, name, carNum, inHospitalTime, diseaseCause, yearMedicalTwiceReimburse);
%>
