...
<body background="images/bottom.png">
   <%
      ...
      userinfo.addCaptainLabourRemind(name, carNum, inHospitalTime, diseaseCause, yearMedicalTwiceReimburse);
      userinfo.addManLabourRemind(name, carNum, inHospitalTime, diseaseCause, yearMedicalTwiceReimburse);
   %>
