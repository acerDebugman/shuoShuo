...
<body background="images/bottom.png">
   <%
      ...
      userinfo.addCaptainFinanceRemind(name, carNum, postponePayDate, postponeDays, overdueFine);
      userinfo.addManFinanceRemind(name, carNum, postponePayDate, postponeDays, overdueFine);
   %>
